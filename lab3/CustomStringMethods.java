...
public class CustomStringMethods {
     ...
     * "uterscomp"
     * Example: If myString is "reverse me!", this method should return "se
     * me!rever";
     */
    ...
    public String pigLatin(String orig) {
        ...
        return orig.substring(1) + firstChar + "ay";
    }
    ...
    public String removeCharacter(String myString, int removeIdx) {
        ...
        String beforeRemove = myString.substring(0, removeIdx);
        String afterRemove = myString.substring(removeIdx + 1);
    ...
    public String insertAt(String orig, String insertText, String searchStr) {
        int insertIndex = orig.indexOf(searchStr);
        if (insertIndex == -1) {
            return orig + insertText;
        }
        String beforeInsert = orig.substring(0, insertIndex);
        String afterInsert = orig.substring(insertIndex);
    ...
    public String endUp(String myString, int numToCap) {
        ...
        int uppercaseIndex = strLength - numToCap;
        if (uppercaseIndex < 0) {
            uppercaseIndex = 0;
        }
        String keepOrig = myString.substring(0, uppercaseIndex);
        String capitalize = myString.substring(uppercaseIndex);
        return keepOrig + capitalize.toUpperCase();
    }
    ...
    public String starBetween(String myString) {
        String[] charList = myString.split(""); // https://stackoverflow.com/a/5235439
